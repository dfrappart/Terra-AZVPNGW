...
module "FEApps_Subnet_vNet3" {
  ...
  NSGid               = "${module.NSG_FEApps_Subnet_vNet3.Id}"
  EnvironmentTag      = "${var.EnvironmentTag}"
  EnvironmentUsageTag = "${var.EnvironmentUsageTag}"
}
...
module "NSG_BEApps_Subnet_vNet3" {
  #Module location
  #source = "./Modules/07 NSG"
  source = "github.com/dfrappart/Terra-AZBasiclinuxWithModules//Modules//07 NSG/"

  #Module variable
  NSGName             = "NSG_${lookup(var.SubnetName, 1)}_vNet3"
  RGName              = "${module.ResourceGroup.Name}"
  NSGLocation         = "${lookup(var.AzureRegion, 0)}"
  EnvironmentTag      = "${var.EnvironmentTag}"
  EnvironmentUsageTag = "${var.EnvironmentUsageTag}"
...
module "BEApps_Subnet_vNet3" {
  ...
  NSGid               = "${module.NSG_BEApps_Subnet_vNet3.Id}"
  EnvironmentTag      = "${var.EnvironmentTag}"
  EnvironmentUsageTag = "${var.EnvironmentUsageTag}"
}
...
module "NSG_INFRA_Subnet_vNet3" {
  #Module location
  #source = "./Modules/07 NSG"
  source = "github.com/dfrappart/Terra-AZBasiclinuxWithModules//Modules//07 NSG/"

  #Module variable
  NSGName             = "NSG_${lookup(var.SubnetName, 2)}_vNet3"
  RGName              = "${module.ResourceGroup.Name}"
  NSGLocation         = "${lookup(var.AzureRegion, 0)}"
  EnvironmentTag      = "${var.EnvironmentTag}"
  EnvironmentUsageTag = "${var.EnvironmentUsageTag}"
...
module "INFRA_Subnet_vNet1" {
  ...
  RGName              = "${module.ResourceGroup.Name}"
  vNetName            = "${module.vNet1.Name}"
  Subnetaddressprefix = "${lookup(var.vNet3SubnetAddressRange, 2)}"
  NSGid               = "${module.NSG_INFRA_Subnet_vNet3.Id}"
  EnvironmentTag      = "${var.EnvironmentTag}"
  EnvironmentUsageTag = "${var.EnvironmentUsageTag}"
}
...
module "NSG_FEADMIN_Subnet_vNet3" {
  #Module location
  #source = "./Modules/07 NSG"
  source = "github.com/dfrappart/Terra-AZBasiclinuxWithModules//Modules//07 NSG/"

  #Module variable
  NSGName             = "NSG_${lookup(var.SubnetName, 3)}_vNet3"
  RGName              = "${module.ResourceGroup.Name}"
  NSGLocation         = "${lookup(var.AzureRegion, 0)}"
  EnvironmentTag      = "${var.EnvironmentTag}"
  EnvironmentUsageTag = "${var.EnvironmentUsageTag}"
...
module "FEADMIN_Subnet_vNet3" {
  ...
  NSGid               = "${module.NSG_FEADMIN_Subnet_vNet3.Id}"
  EnvironmentTag      = "${var.EnvironmentTag}"
  EnvironmentUsageTag = "${var.EnvironmentUsageTag}"
}
